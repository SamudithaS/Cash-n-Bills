...
public class IncomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = FirebaseDatabase.getInstance("https://cash-n-bills-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("IncomeData").child(uid);
