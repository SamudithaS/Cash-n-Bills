...
public class DashboardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String databaseUrl = "https://cash-n-bills-default-rtdb.asia-southeast1.firebasedatabase.app/";
        ...
        mIncomeDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                lastIncomeDateTextView.setText(lastIncomeDate != null ? lastIncomeDate : "N/A");
        ...
        mExpenseDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                lastExpenseDateTextView.setText(lastExpenseDate != null ? lastExpenseDate : "N/A");
                updatePieChart(myView);
            }
