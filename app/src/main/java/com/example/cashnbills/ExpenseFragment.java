...
public class ExpenseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = FirebaseDatabase.getInstance("https://cash-n-bills-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("ExpenseData").child(uid);
